...
- moving rgps ahoy function to main functions file
...
- removed "Powered by Wordpress & rgps" from footer, because let's face it: we all delete this anyway.
...
- removed default "rgps" text in footer if you don't have a menu
...
- added rgps body class depending on what browser
...
- added post formats to rgps.php core
...
- fixed error in rgps.php for menu fallback **thanks Mark**
...
- moved the custom script call and pngfix to the footer
	from the rgps file so it's easier to see what's being
	called.
